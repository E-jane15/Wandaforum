  ...
  return (
    <div className="text-white w-full">
      <div className=" flex items-center justify-center md:justify-between px-20 my-6 sticky top-0">
        <img src={logo} alt="" />
        <a href="" className="text-lg font-medium text-orange ">
          Home
        </a>
        <a href="" className="text-lg font-medium hover:text-orange">
          Community
        </a>
        <a href="" className="text-lg  hover:text-orange font-medium">
          Peermocks
        </a>
        <a href="" className="text-lg font-medium hover:text-orange">
          Pricing
